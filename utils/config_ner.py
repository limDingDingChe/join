...
class ConfigNer:
    def __init__(self,
        ...
        # self.relations = ["N", '丈夫', '上映时间', '专业代码', '主持人', '主演', '主角', '人口数量', '作曲', '作者',
        #                   '作词', '修业年限', '出品公司', '出版社', '出生地',
        #                   '出生日期', '创始人', '制片人', '占地面积', '号', '嘉宾', '国籍', '妻子', '字', '官方语言',
        #                   '导演', '总部地点', '成立日期', '所在城市', '所属专辑',
        #                   '改编自', '朝代', '歌手', '母亲', '毕业院校', '民族', '气候', '注册资本', '海拔', '父亲',
        #                   '目', '祖籍', '简称', '编剧', '董事长', '身高',
        #                   '连载网站', '邮政编码', '面积', '首都']
